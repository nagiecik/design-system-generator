  ...
  if (msg.type === 'create-palette') {
    ...
    try {
      ...
      const systemVariablesMapping = [
        ...
        { name: "surfaceVariant", oldName: "canvas", light: "neutral/90", lightContrast: "neutral/90", dark: "neutral/25", darkContrast: "neutral/30", accessibility: "neutral/30" },
        { name: "onSurfaceVariant", oldName: "onCanvas", light: "neutral/30", lightContrast: "neutral/0", dark: "neutral/80", darkContrast: "neutral/90", accessibility: "neutral/90" },
        { name: "onSurfaceVariantMuted", oldName: "onCanvasVariant", light: "neutral/50", lightContrast: "neutral/30", dark: "neutral/50", darkContrast: "neutral/60", accessibility: "neutral/60" },
        ...
        //inverse
        { name: "surfaceContrast", oldName: "canvasContrast", light: "neutral/15", lightContrast: "neutral/15", dark: "neutral/90", darkContrast: "neutral/90", accessibility: "neutral/90" },
        { name: "onSurfaceContrast", oldName: "onCanvasContrast", light: "neutral/98", lightContrast: "neutral/100", dark: "neutral/15", darkContrast: "neutral/0", accessibility: "neutral/0" },
        //canvas -> surface -> layer scale
        ...
        { name: "surfaceDark", oldName: ["surfaceInverse"], light: "neutral/5", lightContrast: "neutral/0", dark: "neutral/5", darkContrast: "neutral/0", accessibility: "neutral/0" },
        { name: "onSurfaceDark", oldName: ["onSurfaceInverse"], light: "neutral/90", lightContrast: "neutral/98", dark: "neutral/90", darkContrast: "neutral/98", accessibility: "neutral/100" },
        //outline
